...
?>
	...
	<div id="page-wrapper">
		...
		<div class="row">
			<div class="col-lg-12">				
				<h1 class="page-header">Form Check-In Detail</h1>				
				<div class="panel panel-primary">
					<div class="panel panel-body">
							 <div class="col-lg-5">
							 	<div class="row">
									...
									<div class="row">
										...
										<div class="col-lg-6">: <?php if(isset($guest_detail->gender)){ echo $guest_detail->gender=1?'Mele':'Female';} ?></div>
									</div>
									<div class="row">
									...
									<div class="row">
										...
										<div class="col-lg-6">: <?php if(isset($guest_detail->location)){echo $guest_detail->location;} ?></div>
									</div>
									<div class="row">
										<div class="col-lg-6"><b>Country</b></div>
										<div class="col-lg-6">: <?php if(isset($guest_detail->country)){echo $guest_detail->country;} ?></div>
									</div>
									<div class="row">
							...
							<div class="col-lg-7">
								<div class="row">
									<div class="panel panel-heading">
										<h3><b>Check-In Information</b></h3>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-lg-6">: <?php if(isset($value->check_in_remark)){ echo $value->check_in_remark;}?></div>
								</div><hr>	
							<?php } ?>
								</div>
                            </div>
                            <div class="col-lg-12" style="margin-top:20px">
                            	<div class="pull-right">
                            		<a href="<?php echo site_url("admin/Check_in");?>" class="btn btn-default fa fa-close"> Close</a>											
                            	</div>
                            </div>
						</div>
					</div>
