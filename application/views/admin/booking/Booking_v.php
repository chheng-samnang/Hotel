								    ...
								    <div class="row">
								    	<div class="col-md-6">
								    		<label class="control-label">Check In</label>
						      				<div class="input-group datetimepicker"> 
						      					<?php echo form_input(array("name"=>"txtCheckIn","id"=>"txtCheckIn","ng-model"=>"txtCheckIn","value"=>set_value("txtEndDate"),"ng-click"=>"check_room()","class"=>"form-control datetimepicker input-sm","placeholder"=>"check-in"));?>		      											      					                                         		                                          
								    	...
								    	<div class="col-md-6">
								    		<label class="control-label">Check Out</label>
						      				<div class="input-group datetimepicker">
						      					<?php echo form_input(array("name"=>"txtCheckOut","id"=>"txtCheckOut","ng-model"=>"txtCheckOut","value"=>set_value("txtEndDate"),"class"=>"form-control datetimepicker input-sm","ng-click"=>"check_room(2)","placeholder"=>"check-out date"));?>		      											      					                                         		                                          
		                                        <span class="input-group-addon">
		                                            <span class="glyphicon glyphicon-calendar"></span>
		                                        </span>                                
                                    		</div>			        					        						        						        	
